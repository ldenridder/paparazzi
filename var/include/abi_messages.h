/* Automatically generated by gen_abi from /home/hajo/paparazzi/conf/abi.xml */
/* Version v5.17_devel-205-g1aebdbae3-dirty */
/* Please DO NOT EDIT */
...
typedef void (*abi_callbackNAVIGATION_VECTOR)(uint8_t sender_id, int allowableDistance1, int allowableDistance2, int allowableDistance3, int allowableDistance4, int allowableDistance5, int allowableDistance6, int allowableDistance7);
...
static inline void AbiSendMsgNAVIGATION_VECTOR(uint8_t sender_id, int allowableDistance1, int allowableDistance2, int allowableDistance3, int allowableDistance4, int allowableDistance5, int allowableDistance6, int allowableDistance7) {
  abi_event* e;
  ABI_FOREACH(abi_queues[ABI_NAVIGATION_VECTOR_ID],e) {
    if (e->id == ABI_BROADCAST || e->id == sender_id) {
      abi_callbackNAVIGATION_VECTOR cb = (abi_callbackNAVIGATION_VECTOR)(e->cb);
      cb(sender_id, allowableDistance1, allowableDistance2, allowableDistance3, allowableDistance4, allowableDistance5, allowableDistance6, allowableDistance7);
    }
  }
}
