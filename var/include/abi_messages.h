/* Automatically generated by gen_abi from /home/ldenridder/paparazzi/conf/abi.xml */
/* Version v5.17_devel-149-g398b2eda1 */
/* Please DO NOT EDIT */
...
#define ABI_NAVIGATION_VECTOR_ID 29
...
typedef void (*abi_callbackNAVIGATION_VECTOR)(uint8_t sender_id, int allowableDistance1 ,int allowableDistance2, int allowableDistance3, int allowableDistance4, int allowableDistance5, int allowableDistance6, int allowableDistance7, int green1, int green2, int green3, int green4);
...
static inline void AbiBindMsgNAVIGATION_VECTOR(uint8_t sender_id, abi_event * ev, abi_callbackNAVIGATION_VECTOR cb) {
  if (abi_queues[ABI_NAVIGATION_VECTOR_ID] == ev) return;
  ev->id = sender_id;
  ev->cb = (abi_callback)cb;
  ABI_PREPEND(abi_queues[ABI_NAVIGATION_VECTOR_ID],ev);
}

static inline void AbiSendMsgNAVIGATION_VECTOR(uint8_t sender_id, int allowableDistance1 ,int allowableDistance2, int allowableDistance3, int allowableDistance4, int allowableDistance5, int allowableDistance6, int allowableDistance7, int green1, int green2, int green3, int green4) {
  abi_event* e;
  ABI_FOREACH(abi_queues[ABI_NAVIGATION_VECTOR_ID],e) {
    if (e->id == ABI_BROADCAST || e->id == sender_id) {
      abi_callbackNAVIGATION_VECTOR cb = (abi_callbackNAVIGATION_VECTOR)(e->cb);
      cb(sender_id, allowableDistance1,allowableDistance2,allowableDistance3,allowableDistance4,allowableDistance5,allowableDistance6,allowableDistance7,green1,green2,green3,green4);
    }
  }
}
