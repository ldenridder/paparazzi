...
#ifndef MAV_COURSE_EXERCISE_H
#define MAV_COURSE_EXERCISE_H
...
extern float avoidance_heading_direction;  // heading change direction for avoidance [rad/s]
extern float last_avoidance_heading_direction;  // heading change direction for avoidance [rad/s]
extern float slow_avoidance_heading_direction;  // heading change direction for avoidance [rad/s]
extern float last_slow_avoidance_heading_direction;
extern float rapid_avoidance_heading_direction;  // heading change direction for avoidance [rad/s]


extern void mav_course_exercise_init(void);
extern void mav_course_exercise_periodic(void);
